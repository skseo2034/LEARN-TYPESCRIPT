        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isDeathLoading = true;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, index_1.CovidStauts.Deaths)];
                case 1:
                    deathResponse = (_a.sent()).data;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, index_1.CovidStauts.Recovered)];
                case 2:
                    recoveredResponse = (_a.sent()).data;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, index_1.CovidStauts.Confirmed)];
                case 3:
...
function setRecoveredList(data) {
    ...
    sorted.forEach(function (value) {
        ...
        li.appendChild(span);
        li.appendChild(p);
        recoveredList === null || recoveredList === void 0 ? void 0 : recoveredList.appendChild(li); // 옵셔널 체이닝 연산자
