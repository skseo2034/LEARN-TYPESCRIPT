		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					...
					return [
						4 /*yield*/,
						fetchCountryInfo(selectedId, 'deaths'),
					];
				case 1:
					deathResponse = _a.sent().data;
					return [
						4 /*yield*/,
						fetchCountryInfo(selectedId, 'recovered'),
					];
				case 2:
					recoveredResponse = _a.sent().data;
					return [
						4 /*yield*/,
						fetchCountryInfo(selectedId, 'confirmed'),
					];
				case 3:
...
function setupData() {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [4 /*yield*/, fetchCovidSummary()];
				case 1:
					data = _a.sent().data;
...
function setChartData(data) {
	var chartData = data.slice(-14).map(function (value) {
		return value.Cases;
	});
	var chartLabel = data.slice(-14).map(function (value) {
